...
const steps = [
  ...
  },
  {
    ...
    fr: {
      ...
      desc: "Mise en ligne sur votre hébergement (Netlify, VPS, hébergeur client), tests finaux, formation administration et support 30 jours. Intégrations IA disponibles en option.",
    },
    en: {
      title: "Deployment & launch",
      desc: "Go-live on your hosting (Netlify, VPS, client hosting), final testing, admin training and 30-day support. AI integrations available as an add-on.",
    },
  },
];
...
const included = {
  fr: [
    ...
    "Site bilingue FR/EN (option disponible)",
  ...
  en: [
    ...
    "Bilingual FR/EN (available on request)",
