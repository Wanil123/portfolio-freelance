// src/components/offers/OffersData.js
import { Layout, ShoppingBag, Code2, Bot } from "lucide-react";

export const getTabs = (lang) =>
  lang === "fr"
    ? [
  ...
  ai: {
    fr: [
      ...
      },
      {
        ...
        roi: "Conçu pour s'autofinancer rapidement",
        popular: false,
    ...
    en: [
      ...
      },
      {
        ...
        roi: "Designed to pay for itself quickly",
        popular: false,
        color: "from-emerald-400 to-teal-500",
        accent: "text-emerald-400",
        accentBg: "bg-emerald-500/10 border-emerald-500/20",
